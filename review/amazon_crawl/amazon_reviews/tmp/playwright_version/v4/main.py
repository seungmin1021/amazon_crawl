...
import random
import config
from utils import load_asin_info_from_excel, save_failed_asin, save_results_to_json
...
def main():
    ...
    try:
        ...
        # 크롤링 결과 저장
        save_results_to_json(all_results, reviews_output_path, logger=logger)
        if failed_info:
        ...
        try:
            db_saver = MongoSaver()
            db_saver.save_json_file(reviews_output_path)
