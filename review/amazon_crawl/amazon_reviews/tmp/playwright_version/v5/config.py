...
# 실패 유형 상수
FAILURE_TYPE_PRODUCT_NO_EXIST = "PRODUCT_NO_EXIST" # 제품자체가 없음
FAILURE_TYPE_NO_REVIEWS = "NO_REVIEWS" # 리뷰 1개도 없음
FAILURE_TYPE_CRAWLING_ERROR = "CRAWLING_ERROR" # 리뷰 extract 추출 중 오류 
FAILURE_TYPE_OTHER = "OTHER" # 네트워크 지연
...
MONGO_PASSWORD = os.getenv("MONGO_PASSWORD", "adminpw")