...
# ASIN 엑셀에서 일부만 테스트할 때 사용할 슬라이싱 범위 (main.py에서 인자로 받을 수 있음)
ASIN_SLICE_START = 0  # 기본값: 0 (첫 번째)
ASIN_SLICE_END = None  # 기본값: None (끝까지)
...
#     # 텍스트만 바로 추출
#     ("css", "a[data-hook='review-title'] > span::text"),
#     ("css", "a[data-hook='review-title'] span::text"),
#     ("css", "a[data-hook='review-title']::text"),
#     ("css", "span[data-hook='review-title']::text"),
#     ("css", "span.cr-original-review-content::text"),
#     ("css", "div[data-hook='review-title']::text"),  # 혹시 div로 바뀔 경우 대비
#     ("css", "a[data-hook='review-title'] span"),  # a > span
#     ("css", "a[data-hook='review-title']"),       # a 자체
#     ("css", "span[data-hook='review-title'] span.cr-original-review-content"),
#     ("css", "span[data-hook='review-title']"),
#     ("css", "span.cr-original-review-content"),
# ]
...
#     'a[data-hook="review-title"]::text',
#     'span[data-hook="review-title"]::text',
#     'span.cr-original-review-content::text',
#     'span.cr-translated-review-content::text',
# ]
...
#     ("css", "span[data-hook='review-title']"),
#     ("css", "span.cr-original-review-content"),  # title 위치에만!
# ]
REVIEW_TITLE_SELECTORS = [
...
#     ("css", "span[data-hook='review-body'] span"),
#     ("css", "div[data-hook='review-body']::text"),  # 혹시 div로 바뀔 경우 대비
#     # 필요시 추가
# ]
...
# 리뷰 옵션(색상, 용량 등) selector
# REVIEW_OPTION_SELECTORS = [
#     ("css", "a[data-hook='format-strip']"),
#     ("css", "div.review-format-strip a"),
#     ("xpath", "//a[contains(@data-hook, 'format-strip')]"),
# ]
REVIEW_OPTION_SELECTORS = [
...
# 리뷰 Verified Purchase 여부 selector
# REVIEW_VERIFIED_SELECTORS = [
#     ("css", "span[data-hook='avp-badge']"),
#     ("css", "span.a-color-state.a-text-bold"),
#     ("xpath", "//span[contains(@data-hook, 'avp-badge')]"),
# ]
REVIEW_VERIFIED_SELECTORS = [
...
# 리뷰 페이지 네비게이션(Next page) 버튼 selector
# v1 버전 기준  
# REVIEW_NEXT_PAGE_SELECTORS = [
#     ("css", "ul.a-pagination li.a-last:not(.a-disabled) a"),
#     ("xpath", "//ul[contains(@class, 'a-pagination')]/li[contains(@class, 'a-last') and not(contains(@class, 'a-disabled'))]/a"),
#     ("xpath", "//a[contains(text(), 'Next page')]"),
# ]

# REVIEW_NEXT_PAGE_SELECTORS = [
#     "//a[contains(text(), 'Next page')]",  # 텍스트로 찾기
#     "//div[@class='a-text-center']/ul[@class='a-pagination']/li[@class='a-last']/a",  # a-last 클래스로 찾기
#     "//ul[@class='a-pagination']/li[contains(@class, 'a-last')]/a"  # 다른 페이지네이션 형식
# ]
